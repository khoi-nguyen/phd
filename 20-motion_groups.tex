...
Every time we integrate on $\VectorSpace$,
it will be with respect to the unique Haar measure $\mu$ on $\VectorSpace$ such that
\begin{align*}
...
\begin{definition}[$K$-invariant Lebesgue measure]
...
$\Group$ will denote a motion group,
...
we can represent the motion group $\Group$

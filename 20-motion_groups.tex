...
\begin{definition}[Lie algebra of $\Group$]
    ...
    \begin{align*}
        \LieAlgebra \defeq
        \VectorSpace \otimes \LieAlgebraCompactGroup
    \end{align*}
...
\label{example:Lie_Algebra_of_2-dimensional_Euclidean_motion_group}
    ...
    \begin{align*}
        \LieAlgebra \defeq \R^2 \otimes \SkewSymmetric{\R^2}.
    \end{align*}
...
\begin{example}[Euclidean motion groups]
    ...
    \begin{align*}
        \LieAlgebra \defeq \R^n \otimes \SkewSymmetric {\R^n}.
    \end{align*}
    ...
    \begin{align*}
        X_i &\defeq e_i \otimes 0_{\SquareMatrices n}, &\quad &i = 1, \dots, n\\
        X_{ij} &\defeq 0_{\R^n} \otimes E_{ij}, &\quad &i,j \in \{1, \dots, n\} \text{ with } i < j,
    \end{align*}
...
\begin{align*}
    \LieAlgebra = \VectorSpace \otimes \mathfrak a \otimes \mathfrak s,
\end{align*}

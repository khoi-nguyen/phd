...
\label{lemma:derivative_of_Taylor_polynomial_and_remainder}
    ...
    we have
    \begin{align*}
        \TaylorLeftDifferentialOperator \beta \TaylorPolynomial f g N
        = \TaylorPolynomial {\TaylorLeftDifferentialOperator \beta f} g {N - \abs \beta},
        \quad
        \TaylorLeftDifferentialOperator \beta \TaylorRemainder f g N
        = \TaylorRemainder {\TaylorLeftDifferentialOperator \beta f} g {N - \abs \beta}.
    \end{align*}
\end{lemma}

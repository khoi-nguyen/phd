...
\begin{example}[$h \equiv C$]
    ...
    \begin{align*}
        \hat f(\lambda; t) = \exp_{\MotionGroup 2}(t A(\lambda)),
    \end{align*}
    ...
    \begin{align*}
        f(y, s; t) = \int_\VectorSpace \tr\left( \Rep [\MotionGroup 2] \lambda (y, s) \exp_{\MotionGroup 2}(t A(\lambda)) \right) \dd \lambda.
    \end{align*}
\end{example}

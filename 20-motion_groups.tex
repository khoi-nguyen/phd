...
One of the consequences of the invariance of $\Laplacian [\VectorSpace]$ under rotations
is that the so-called \emph{heat equation}
\begin{align*}
    \D 1 [u] t (t, g) &= \Laplacian u(t, g)
\end{align*}
is identical for $\GroupDirect$ and $\Group$.

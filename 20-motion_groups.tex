...
if it is the \emph{semi-direct product} between a vector space and a compact connected subgroup of $\GeneralLinear \VectorSpace$.
...
\index{motion group}
    ...
    such that $\Group = \VectorSpace \times \CompactGroup$ as a set, and
    \begin{align*}

...
\begin{application}[3D Fokker-Planck equation]
    % TODO: Explain what the quantities represent
    \begin{align}
        \begin{cases}
            \D{1}[f]{s} &= -h(s) \cos (\turn t) \D{1}[f]{{x_1} } - h(s) \sin(\turn t) \D{1}[f]{{x_2} } + C \D{2}[f]{t^2}\\

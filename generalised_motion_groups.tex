...
\label{lemma:Haar_measure}
    If $\dd x$ is a Lebesgue measure on $\VectorSpace$ and $\dd k$ is the Haar measure on $\CompactGroup$,
...
\index{unitary dual}
    ...
    \begin{align*}
        \dualGroup{\Group} = \{ (\Hilbert{\sigma}{1}, \Rep{\rho}) : \rho \in \LeftQuotient{\IsotropySubgroup{K}{\rho_0}}{\dualGroup{\VectorSpace}}, \sigma \in \dualGroup{\IsotropySubgroup{\CompactGroup}{\rho}} \}.
    \end{align*}
\end{definition}

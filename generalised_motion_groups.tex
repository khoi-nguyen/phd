...
Throughout this section, fix $\lambda \in \dualGroup{V}$
...
\index{infinitesimal representation}
    ...
    \begin{align*}
        \Rep{\lambda}(X) : \SmoothFunctions{K} \to \SmoothFunctions{K}
    \end{align*}
    defined via
    \begin{align*}

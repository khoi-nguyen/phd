...
\label{section:difference_operators}

\section{Symbols and Kohn-Nirenberg quantization}
\label{section:symbols_and_Kohn-Nirenberg_quantization}
    ...
    \begin{description}
        ...
        \item[Step 3] We show that for every $q \in \Polynomials{\Group}$
            ...
            \begin{claim}
                ...
                \begin{align*}
                    \DifferenceOperator[\VectorSpace]{q_1} \chi_{l - \Ceiling{\log_2 \JapaneseBracket{\CompactGroup}{\tau}}}(k \rho) = \sum_{r = 1}^{C_q} f_{l, r}(\tau, \rho) q_r(k),
                \end{align*}
                where $q_r$ and $f_{l, r}$ satisfies the following bound:
                \begin{align}
                    \sup_{l \in \N} \sup_{\tau \in \dualGroup{\CompactGroup}} \sup_{\rho \in \dualGroup{\VectorSpace}} \abs{f_{l, r}(\tau, \rho)} < \infty,\quad
            ...
            \begin{proof}[Proof of the claim]
                ...
                Since
                \begin{align*}
                    \chi_{l - \Ceiling{\log_2 \JapaneseBracket{\CompactGroup}{\tau}}}(\rho)
                    = \chi_1(2^{-l + \Ceiling{\log_2 \JapaneseBracket{\CompactGroup}{\tau} + 1}} \rho),
                \end{align*}
                it follows that
                \begin{align*}
                    \DifferenceOperator[\VectorSpace]{q_1} \chi_{l - \Ceiling{\log_2 \JapaneseBracket{\CompactGroup}{\tau}}}(k \rho)
                    ...
                    \DifferenceOperator[\VectorSpace]{q_1} \chi_1(2^{-l + \Ceiling{\log_2 \JapaneseBracket{\CompactGroup}{\tau} + 1}} k \rho).
                \end{align*}
                ...
                \begin{align*}
                    \DifferenceOperator[\VectorSpace]{q_1} &\chi_{l - \Ceiling{\log_2 \JapaneseBracket{\CompactGroup}{\tau}}}(k \rho) =
                    2^{(-l + \Ceiling{\log_2 \JapaneseBracket{\CompactGroup}{\tau} + 1}) \order{q_1}}\\
                    &\sum_{r = 1}^{C_q} f_r(2^{-l + \Ceiling{\log_2 \JapaneseBracket{\CompactGroup}{\tau} + 1}} \norm[\dualGroup{\VectorSpace}]{\rho}) q_r(k) P_r(2^{-l + \Ceiling{\log_2 \JapaneseBracket{\CompactGroup}{\tau} + 1}} \rho),
                \end{align*}
                ...
                \begin{align*}
                    f_{l, r}(\tau, \rho) &=
                    2^{(-l + \Ceiling{\log_2 \JapaneseBracket{\CompactGroup}{\tau} + 1}) \order{q_1}}
                    f_r(2^{-l + \Ceiling{\log_2 \JapaneseBracket{\CompactGroup}{\tau} + 1}} \norm[\dualGroup{\VectorSpace}]{\rho}) P_r(2^{-l + \Ceiling{\log_2 \JapaneseBracket{\CompactGroup}{\tau} + 1}} \rho),
                \end{align*}
            ...
            \begin{align}
                \sigma_{l, \rho, p, r}(u, \tau) =
                \begin{cases}
                    \frac{1}{\dimRep{\tau}} {q'}_{2, p}(u^{-1}) f_{l, r}(\tau, \rho) \Id{\dimRep{\tau}} & \text{if } \JapaneseBracket{\CompactGroup}{\tau} \leq 2^l\\
                    0 & \text{otherwise}
                \end{cases}
            \end{align}
            and denoting by $T_{l, \rho, p, r}$ the corresponding operators,
            we see that in fact,
            \begin{align*}
                \DifferenceOperator{q} \eta_l (\rho) F(u)
                = &\sum_{p, r = 1}^{C_q}
        ...
        \item[Step 4] $\ip[\Lebesgue{2}{\CompactGroup}]{\DifferenceOperator{q} \eta_l(\rho) \mu_{mn}}{\nu_{kl}}$ is non-zero
            only if $\norm[\dualGroup{V}]{\rho}, \JapaneseBracket{\CompactGroup}{\mu}, \JapaneseBracket{\CompactGroup}{\nu} \leq C_q 2^l$.
            ...
            \begin{align*}
                \ip[\Lebesgue{2}{\CompactGroup}]{\DifferenceOperator{q} \eta_l(\rho) \mu_{mn}}{\nu_{kl}} = 0.
            \end{align*}

            The condition on $\rho$ is obvious by~\eqref{eq:theorem:Littlewood-Paley_decomposition:rho_condition}
        ...
        \item[Step 5] Conclusion.
            ...
            \begin{align*}
                L_l(\rho) =
                \begin{cases}
                    {\left. \Rep{\rho} \BesselPotential{1} \right|}_{\oplus_{\JapaneseBracket{\CompactGroup}{\tau} \leq C_q 2^l} V_\tau}
            ...
            \begin{align*}
                \norm[\Lin{\Lebesgue{2}{\CompactGroup}}]{\Rep{\rho} \BesselPotential{- m - \order(q) + \gamma} \DifferenceOperator{q} \eta_l(\rho) \Rep{\rho} \BesselPotential{-\gamma}}
                \leq C_q 2^{-l m},
            \end{align*}
...
\label{section:kernel_estimates}

\section{Adjoint and composition formulas}
\label{section:adjoint_and_composition_formulas}

\section{$L^2$ boundedness}
\label{section:L2_boundedness}

...
\begin{proof}
    \begin{description}
        \item[Step 1] Constructing the dyadic decomposition.
            ...
            \begin{align*}
                \chi_0(\lambda) = 1 \  \text{if}\  \norm[\dualGroup{V}]{\lambda} \leq 1, \quad \text{and} \quad
                \chi_0(\lambda) \equiv 0 \ \text{if}\  \norm[\dualGroup{V}]{\lambda} \geq 2.
            \end{align*}
        ...
        \item[Step 3] We show that for every $q \in \Polynomials{\Group}$
            ...
            we obtain:
            \begin{align*}
                \norm[\Lin{\Lebesgue{2}{K}}]{T_{l, \lambda, p, r}}
        ...
        \item[Step 4] $\ip[\Lebesgue{2}{\CompactGroup}]{\DifferenceOperator{q} \eta_l(\lambda) \mu_{mn}}{\nu_{kl}}$ is non-zero
            only if $\norm[\dualGroup{V}]{\lambda}, \JapaneseBracket{\CompactGroup}{\mu}, \JapaneseBracket{\CompactGroup}{\nu} \leq C_q 2^l$.
        ...
        \item[Step 5] Conclusion.
            ...
            \begin{align*}
                ...
                \begin{cases}
                    ...
                    & \text{if } \norm[\dualGroup{V}]{\lambda} \leq C_q 2^l\\
                    0 & \text{otherwise},
                \end{cases}
            \end{align*}
            where $C_q$ is given by Step 4.

            Observe that $L_l(\lambda)$ is a bounded operator in $\Lebesgue{2}{K}$,

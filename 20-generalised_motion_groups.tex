...
\begin{lemma}
    ...
    \begin{enumerate}
        \item if $f \in \Schwartz\Group$, then $K_{f, \lambda}$ is smooth,
            ...
            \end{align*}
        \item if $f \in \Lebesgue{1}\Group \cap \Lebesgue{2}\Group$, then $K_{f, \lambda}$ is Hilbert-Schmidt and
            \begin{align*}
...
\begin{proof}
    ...
    By \cite[Corollary 4.1]{DelgadoRuzhansky14}, we know that $\Fourier \phi(\lambda)$ is trace class and
    \begin{align*}

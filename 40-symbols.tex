...
\index{difference operators!admissibility}
    A finite collection $q_1$, \cdots, $q_M \in \SmoothFunctions{\Group}$ of smooth functions is said to be \emph{admissible}
...
\begin{lemma}
    There exists a strongly admissible family $q_1$, \cdots, $q_M \in \SmoothFunctions{\Group}$ on $\Group$ which satisfies the Leibniz-like property.
\end{lemma}
\begin{proof}

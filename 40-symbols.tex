...
\begin{proof}
    ...
    \begin{align*}
        ...
        \Rep \lambda \BesselPotential {-\dim \Group + \gamma}.
    \end{align*}
    ...
    \begin{align*}
        ...
        &\leq
        \begin{cases}
            C \epsilon^\gamma & \text{if } \gamma < \min\{0, - (\dim \Group + m)\}\\
            C \log \epsilon & \text{if } \gamma = 0 \text{ and } m = -\dim \Group.
        \end{cases}
    \end{align*}

    Using $\norm [\Group] h = \epsilon$,
    and letting $\gamma = 0$ when $m = -\dim \Group$,
    ...
    \begin{align*}
        ...
        &\leq
        \begin{cases}
            C \norm [\Group] h^\gamma & \text{if } m > -\dim \Group \text{ and } \gamma < - (\dim \Group + m)\\
            C \log \norm [\Group] h & \text{ if } m = -\dim \Group.
        \end{cases}
    \end{align*}

...
\label{theorem:generalised_Littlewood-Paley_decomposition}
    ...
    \begin{enumerate}
        \item For each $m \leq 0$ and each $N \in \N$,
...
\begin{proof}
    ...
    \begin{description}
        ...
        \item [Step 4a] Conclude when $\alpha_1 \neq 0$.
            ...
            \begin{align*}
                R_\lambda =
                \bigoplus \{V_\tau : c_\alpha \epsilon^{-2} \leq \JapaneseBracket \CompactGroup \tau \norm \lambda \leq C_\alpha \epsilon^{-2} \text{ and } \JapaneseBracket \CompactGroup \tau \leq C_\alpha \epsilon^{-1} \}
            \end{align*}
            ...
            \begin{align*}
                ...
                \eval {\Rep \lambda \BesselPotential 1} {R_\lambda}
                \oplus c_\alpha \epsilon^{-2} \Id {R_\lambda^\perp}
            \end{align*}
            ...
            \end{align*}
            which concludes the proof when $\alpha_1 \neq 0$.

        \item [Step 4b] Assume that $\alpha_1 = 0$.
            ...
            \begin{align*}
                \DifferenceOperatorOrder \alpha \eta_\epsilon(\lambda) F(u)
                = \bigoplus_{\JapaneseBracket \CompactGroup \tau \leq \epsilon^{-1}}
                \chi_{\epsilon^2 \JapaneseBracket \CompactGroup \tau}(\lambda)
                \eval {\DifferenceOperatorOrder [\CompactGroup] {\alpha_2} \Id {\Lebesgue 2 \CompactGroup}} {V_\tau} F(u).
            \end{align*}
            Therefore, as the above operator is block diagonal in the Peter-Weyl basis,
            \begin{align*}
                &\Rep \lambda \BesselPotential {-m + \rho \abs \alpha_2 + \gamma}
                \DifferenceOperatorOrder \alpha \eta_\epsilon(\lambda)
                \Rep \lambda \BesselPotential {-\gamma}\\
                &= \bigoplus_{\JapaneseBracket \CompactGroup \tau \leq \epsilon^{-1}}
                \chi_{\epsilon^2 \JapaneseBracket \CompactGroup \tau}(\lambda)
                (1 + \norm {\turn \lambda}^2 + \lambda_\tau^2)^{\frac {-m + \rho \abs {\alpha_2}} 2} \eval {\DifferenceOperatorOrder [\CompactGroup] {\alpha_2} \Id {\Lebesgue 2 \CompactGroup}} {V_\tau}.
            \end{align*}

            Clearly, the above operator vanishes for $\norm \lambda$, $\JapaneseBracket \CompactGroup \tau \leq \epsilon^{-1}$,
            so that
            \begin{align*}
                &\norm [\Lin {\Lebesgue 2 \CompactGroup}] {%
                    \Rep \lambda \BesselPotential {-m + \rho \abs\alpha + \gamma}

    ...
    \begin{description}
        ...
        \item [Leibniz-like formula]
            ...
            \begin{align*}
                \tau(k) \defeq k
            \end{align*}
            we observe that $\tau$ is a fundamental representation
...
\begin{lemma}[Taylor Theorem]
    ...
    \end{align*}
    be a strongly admissible collection of smooth functions
    containing $\dim \Group$ elements.

    Define a basis $X_j \in \VectorFields$, $j = 1, \dots, \dim \Group$ such that
    \begin{align*}
    ...
    Defining the \emph{Taylor remainder} of $f$ of order $N \in \Group$ at $g \in \Group$ via
    \begin{align*}
        \TaylorRemainder f g N(h) \defeq f(g h) - \sum_{\abs \alpha \leq N} q^\alpha(h^{-1}) \TaylorLeftDifferentialOperator \alpha f(g),
    \end{align*}
...
\label{theorem:kernel_estimates}
    % TODO: Adapt statement with Veronique's reply
...
\begin{definition}[Taylor reminder]

...
\begin{proof}
    ...
    \begin{description}
        ...
        \item [Step 2] Computing $\DifferenceOperatorOrder \alpha \eta_\epsilon$.
            ...
            \begin{align*}
                \begin{cases}
                    \eta_{\epsilon, 0}(\lambda) = \eta_{\epsilon}(\lambda) - \eta_{\epsilon}(2 \lambda)\\
                    \eta_{\epsilon, j}(\lambda) = \eta_{\epsilon, j - 1}(2 \lambda) & j > 1
                \end{cases}
            \end{align*}
            so that
            \begin{align*}
            ...
            = \iD {x^{\alpha_1} } \chi_{\epsilon \JapaneseBracket \CompactGroup \tau}(\lambda) - \iD {x^{\alpha_1} } \chi_{\epsilon \JapaneseBracket \CompactGroup \tau}\right)(2 \lambda)\\
                f_{\alpha_1, \tau, \epsilon, j}(\lambda)
                = f_{\alpha_1, \tau, \epsilon, j}(2 \lambda) & j > 1
                \end{cases}
            \end{align*}

            It is straightforward to check by induction that
            \begin{align*}
                \supp f_{\alpha_1, \tau, \epsilon, j} \subset \{ c 2^{-j} \epsilon^{-1} \leq \JapaneseBracket \CompactGroup \tau \norm \lambda \leq C 2^{-j} \epsilon^{-1} \},
            \end{align*}

...
\begin{theorem}
    ...
    \begin{align*}
        \SymbolSemiNorm m {\rho, \delta} N \sigma \leq C t^\frac m 2
    \end{align*}
    ...
    there exists $C \geq 0$ such that
    \begin{align*}
        \SymbolSemiNorm m {\rho, \delta} N {\Id {\Lebesgue 2 \CompactGroup} - \sigma} \leq C t^\frac m 2
    \end{align*}
\end{theorem}
\begin{proof}
    Let $s < 0$ and $n \in \N$.
    ...
    The result follows, since $s < 0$ and $n \in \N$ are arbitrary.
\end{proof}

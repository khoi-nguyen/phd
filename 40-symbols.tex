...
\label{definition:Taylor_remainder}
    ...
    where in the above
    \begin{align*}
        \TaylorLeftDifferentialOperator \alpha \defeq X_1^{\prime \alpha_1} \dots X_{\dimDifferenceOperators}^{\prime \alpha_{\dimDifferenceOperators}}
    \end{align*}
\end{definition}
...
\section{Asymptotic sums of symbols}
...
\label{proposition:asymptotic_sum_of_symbols}
    ...
    let $(\sigma_j)_{j \in \N}$ be a sequence of symbols such that $\sigma_j \in \SymbolClass {m_j}$,
...
\subsubsection{The case \texorpdfstring{$\rho > \delta$}{rho bigger than delta}}

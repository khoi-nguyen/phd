...
\begin{proof}
    ...
    \begin{align*}
        \eta_\epsilon(\lambda)
        \defeq \sum_{\JapaneseBracket \CompactGroup \tau \leq \epsilon^{-1}} \chi(\epsilon \JapaneseBracket \CompactGroup \tau^{-1} \lambda) \Id {V_\tau},
    \end{align*}
    ...
    \begin{align*}
        ...
        &= \lim_{\epsilon \to 0} \sum_{\JapaneseBracket \CompactGroup \tau \leq \epsilon^{-1}} \chi(\epsilon \JapaneseBracket \CompactGroup \tau^{-1} \lambda) \Id {V_\tau}\\

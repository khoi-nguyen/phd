...
\label{lemma:prepare_kernel_estimates_at_the_origin}
    ...
    we let
    \begin{align*}
        \kappa_{\epsilon, g} \defeq \InverseFourier \{ \sigma(g, \dummy) \eta_\epsilon \},
    \end{align*}
    where $\eta_l$ is the symbol defined in Theorem~\ref{theorem:generalised_Littlewood-Paley_decomposition}.

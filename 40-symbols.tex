...
We now turn our attention to Parts \ref{item:kernel_estimates:at_origin:positive},
\ref{item:kernel_estimates:at_origin:zero} and \ref{item:kernel_estimates:at_origin:negative}.

...
\label{theorem:kernel_estimates}
    ...
    \begin{enumerate}
        \item For every $N \in \N$, there exists $C \geq 0$ such that for every $g, h \in \Group$ with $\norm [\Group] {h} \geq 1$, we have
            \begin{align*}
                \abs{\kappa_g(h)} \leq C \norm [\Group] h^{-N}.
            \end{align*}
        \item If $\dim \Group + m > 0$, there exists $C \geq 0$ such that for every $g, h \in \Group$ with $h \neq 0$, we have
            \begin{align*}

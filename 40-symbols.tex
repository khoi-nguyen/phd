...
\begin{proof}
    ...
    \begin{align*}
        \norm [\Lin {\Lebesgue 2 \CompactGroup}] {%
            \Rep \lambda \BesselPotential {-s m + \rho \abs \alpha - \delta \abs \beta + \gamma}
        ...
        \norm [\Lin {\Lebesgue 2 \CompactGroup}] {%
            \Rep \lambda \BesselPotential {-s m + \rho \abs \alpha - \delta \abs \beta}
            \LeftDifferentialOperator \beta \DifferenceOperator \alpha
            (\sigma(g, \lambda) - \Id {\Lebesgue 2 \CompactGroup})^{-1}
        }\\
    \end{align*}
\end{proof}

...
\end{corollary}
\begin{proof}
    First, let us find a smooth function $\chi \in \SmoothFunctions{\dualGroup{\VectorSpace}}$ invariant under $\CompactGroup$ such that
    \begin{align*}
        \chi(\lambda) = 1 \  \text{if}\  \norm[\dualGroup{\VectorSpace}]{\lambda} \leq 1, \quad \text{and} \quad
    ...
    we define
    \begin{align*}
        \eta_\epsilon(\lambda) \defeq \chi(\epsilon \lambda) \Id {\bigoplus_{\JapaneseBracket \CompactGroup \tau \leq \epsilon^{-1}} \Span \{\tau_{ij} : 1 \leq i, j \leq \dimRep \tau\}}
    \end{align*}
\end{proof}

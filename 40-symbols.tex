...
\begin{lemma}[\cite{RuzhanskyWirth14}, Theorem 3.1. (1)]
    ...
    If $\sigma$ is parameter-elliptic with respect to $\Lambda$, then
...
\begin{proposition}
    ...
    \begin{enumerate}
        ...
        \item If $m_1 < m$, then for each $N \in \N$ there exists $C \geq 0$ and $N' \in \N$ such that
            ...
            \end{align*}
            for each $\epsilon \in (0, 1]$.
        \item If $\phi \in \Schwartz \Group$,
            then $\Op(\sigma_\epsilon) \phi \in \SmoothFunctions \Group$ and
            \begin{align*}
                \lim_{\epsilon \to 0} \sup_{g \in C} \abs{\Op(\sigma_\epsilon) \phi(g) - \Op(\sigma) \phi(g)} = 0
            \end{align*}
            for every compact subset $C \subset \Group$.
    \end{enumerate}
\end{proposition}

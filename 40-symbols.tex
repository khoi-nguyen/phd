    ...
    \begin{enumerate}
        \item
            ...
            \begin{align*}
                ...
                &\leq C \sum_{r \leq \abs \alpha \leq 2 r}
                \SymbolSemiNorm{m_1 - m + \rho \abs \alpha} {\rho, \delta} {2 r} {\eta_{\norm [\Group] h}}.
            \end{align*}

            Since $m_1 - m + \rho \abs \alpha \leq 0$ for each $\alpha$,
            then
            \begin{align*}
                \norm [\Group] h^r
                \abs{\kappa_{\norm [\Group] h, g}(h)}
                \leq C \sum_{r \leq \abs \alpha \leq 2 r}
                \norm [\Group] h^{m_1 - m + \rho \abs \alpha}
        ...
        \item
            ...
            \begin{align*}
                ...
                &\quad \leq C \sum_{r \leq \abs \alpha \leq 2 r}
                \SymbolSemiNorm{m_1 - m + \rho \abs \alpha} {\rho, \delta} {2 r} {\Id {\Lebesgue 2 \CompactGroup} - \eta_{\norm [\Group] h}}.
            \end{align*}
...
\begin{proof}
    ...
    \begin{description}
        \item[Case $m > -\dim \Group$].
            Assume that $m > -\dim \Group$.
            Letting
            \begin{align*}
                m_1 = m\left(1 - \frac 1 \rho\right) - \frac {\dim \Group} \rho
            \end{align*}
            so that $m - m_1 = (\dim \Group + m)/\rho > 0$,
            we obtain
            \begin{align*}
                \abs{\kappa_\epsilon(h)} \leq C \epsilon^{m_1 - m} = C \norm [\Group] h^{- \frac {\dim \Group + m} \rho}.
            \end{align*}
            ...
            Therefore,
            \begin{align*}
                \norm [\Group] h^r \abs{(\kappa_g - \kappa_{\epsilon, g})(h)}
                \leq C \epsilon^{m_1 - m + \rho r}
            \end{align*}

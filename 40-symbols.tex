...
\index{Littlewood-Paley decomposition}
    Suppose that $\Group = A \rtimes \CompactGroup$,
    where $A$ is an abelian group,
    and $\CompactGroup$ is a compact subgroup of $\Aut(A)$ acting transitively on $A$.
    If there exists a sequence $\chi_j$ such that
    \begin{enumerate}

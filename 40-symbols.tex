...
\index{Littlewood-Paley decomposition}
    ...
    and suppose that $\CompactGroup \subset \Aut(\AbelianGroup)$ is a \emph{compact} group such that the \emph{Haar measure of $\AbelianGroup$ is invariant under the action of $\CompactGroup$}.

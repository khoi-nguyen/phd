...
\begin{proof}
    ...
    \begin{description}
        ...
        \item [Step 2] Computing $\DifferenceOperatorOrder \alpha \eta_\epsilon$.
            ...
            \begin{align*}
                &\DifferenceOperatorOrder \alpha \eta_\epsilon(\lambda) F(u)\\
                & \qquad = \bigoplus_{\JapaneseBracket \CompactGroup \tau \leq \epsilon^{-1}}
                \iD {x^{\alpha_1} } \chi_{\epsilon \JapaneseBracket \CompactGroup \tau}(u^{-1} \lambda)
                \eval {\DifferenceOperatorOrder [\CompactGroup] {\alpha_2} \Id {\Lebesgue 2 \CompactGroup}} {V_\tau} F(u).
            \end{align*}

            From that last expression,
            we can deduce that in fact
            \begin{align*}
                \norm [\Lin {\Lebesgue 2 \CompactGroup}] {%
            ...
            \end{align*}
            where $C_{\alpha, \gamma}$ does \emph{not} depend on $\epsilon$ or $\lambda$.
        \item [Step 3] Assume that $m \leq 0$ and define the operator
            \begin{align*}
        ...
        \item [Step 4] Assume now that $m \geq 0$.

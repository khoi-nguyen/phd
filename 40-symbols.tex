    ...
    \begin{description}
        \item [Step 1] Computing the associated kernel $\kappa_\epsilon$.
            ...
            \begin{align}
                ...
                \int_\VectorSpace
                \tr \left(\chi_{\epsilon \JapaneseBracket \CompactGroup \tau^{-1}} (\lambda) \eval {\Rep \lambda(x, k)} {V_\tau}\right) \dd \lambda \notag\\
                = \sum_{\JapaneseBracket \CompactGroup \tau \leq \epsilon^{-1}}
                \tr \left(\int_\VectorSpace
                \chi_{\epsilon \JapaneseBracket \CompactGroup \tau^{-1}} (\lambda) \eval {\Rep \lambda(x, k)} {V_\tau}\right) \dd \lambda,
            ...
            \begin{align*}
                &\left(\int_\VectorSpace \chi_{\epsilon \JapaneseBracket \CompactGroup \tau^{-1}} (\lambda) \eval {\Rep \lambda(x, k)} {V_\tau} \dd \lambda\right) F(u)\\
                &\quad = \int_\VectorSpace \chi_{\epsilon \JapaneseBracket \CompactGroup \tau^{-1} u} (\lambda) \eval {\Rep {u \lambda}(x, k)} {V_\tau} F(u) \dd \lambda\\
                &\quad = \left(\int_\VectorSpace \chi_{\epsilon \JapaneseBracket \CompactGroup \tau^{-1}} (\lambda) \e^{\i \turn \ip \lambda x} \eval {\RightRegularRepresentation(k)} {V_\tau}\right) F(u)\\
                &\quad = \InverseFourier [\R^n] \chi_{\epsilon \JapaneseBracket \CompactGroup \tau^{-1}}(x) \eval {\RightRegularRepresentation(k)} {V_\tau} F(u)
            \end{align*}
            Taking the trace on both sides of the above,
            and keeping in mind that $\eval {\RightRegularRepresentation(k)} {V_\tau} \simeq \tau$,
            we get
            \begin{align*}
                &\tr \left(\int_\VectorSpace \chi_{\epsilon \JapaneseBracket \CompactGroup \tau^{-1}} (\lambda) \eval {\Rep \lambda(x, k)} {V_\tau} \dd \lambda\right)\\
                &\quad = \InverseFourier [\R^n] \chi_{\epsilon \JapaneseBracket \CompactGroup \tau^{-1}}(x) \chi_\tau(k),
            \end{align*}
            ...
            \begin{align}
                \kappa_\epsilon(x, k)
                = \sum_{\JapaneseBracket \CompactGroup \tau \leq \epsilon^{-1}}
                \InverseFourier [\R^n] \chi_{\epsilon \JapaneseBracket \CompactGroup \tau^{-1}}(x) \chi_\tau(k).
        ...
        \item [Step 2] Computing $\DifferenceOperatorOrder \alpha \eta_\epsilon$.
            ...
            \begin{align*}
                ...
                q^{\alpha_1}((x, k)^{-1}) \InverseFourier [\R^n] \chi_{\epsilon \JapaneseBracket \CompactGroup \tau^{-1}}(x) \e^{\i \turn \ip \lambda {u x}}\\
                & \qquad \qquad (q^{\alpha_2} \chi_\tau)(k^{-1}) F(u k) \dd (x, k)\\
                &= \sum_{\JapaneseBracket \CompactGroup \tau \leq \epsilon^{-1}}
                \int_\VectorSpace x^{\alpha_1} \InverseFourier [\R^n] \chi_{\epsilon \JapaneseBracket \CompactGroup \tau^{-1}}(x) \e^{\i \turn \ip \lambda {u x}} \dd x\\
                & \qquad \qquad \int_\CompactGroup (q^{\alpha_2} \chi_\tau)(k^{-1}) F(u k) \dd k\\
                &= \sum_{\JapaneseBracket \CompactGroup \tau \leq \epsilon^{-1}}
                \iD {x^{\alpha_1} } \chi_{\epsilon \JapaneseBracket \CompactGroup \tau^{-1}}(u^{-1} \lambda)
            ...
            \begin{align}
                ...
                (\epsilon \JapaneseBracket \CompactGroup \tau^{-1})^{\alpha_1} \iD {x^{\alpha_1} } \chi(\epsilon \JapaneseBracket \CompactGroup \tau^{-1} u^{-1} \lambda)
                \DifferenceOperatorOrder [\CompactGroup] {\alpha_2} \Fourier [\CompactGroup] \chi_\tau F(u).

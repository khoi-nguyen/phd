...
More importantly,
the analogue of~\eqref{eq:composition_formula_for_characteristic_polynomials} is
\begin{align}
    \sigma(x, \xi)
...
Unfortunately,
the above also means that we shall have to resort to \emph{approximate calculations}.

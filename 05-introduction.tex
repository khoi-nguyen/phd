...
firstly, it is one of the more elementary non-compact groups not yet studied in the context of pseudo-differential calculus;
...
The problem of extending the Fourier transform onto convolution kernels acting on Sobolev spaces (the minimum we need to have a good definition of symbol) was solved in~\cite[Subsection 5.1.1]{FischerRuzhansky16}
Note that the Fourier analysis on the compact case follows from the Peter-Weyl theory,
and the Fourier transform can easily be extended onto the set of distributions.
For more detail,
see~\cite[Section 10.2]{RuzhanskyTurunen10}.

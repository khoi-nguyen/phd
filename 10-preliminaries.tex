...
This chapter aims to very briefly introduce key concepts which will be used in the subsequent chapters,
and we will often omit the proofs.
...
there exists measures which are invariant under the left or right group action.
...
where $\VectorSpace$ is a vector space and $K \subset \SpecialOrthogonalGroup \VectorSpace$.

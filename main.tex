...
\newcommand{\LeftDifferentialOperator}[2][]{X^{#2}_{L\if #1\empty \else ; #1 \fi}}
...
% TODO: Add publisher={一般社団法人 日本数学会} to Kumahara76
% TODO: Use mathscinet for bibliography items
